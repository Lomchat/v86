...
function run(adaptive, program = image())
{
    return new Promise(resolve => {
        ...
        emulator.add_listener("emulator-loaded", () => {
            ...
            cpu.set_jit_config(17, 1);            // one page per Tier-2 module
            cpu.set_jit_config(20, 2);            // intentionally tiny retained set
            cpu.set_jit_config(23, 0);            // isolate replacement from region fusion
...
console.log("jit-tier2-adaptive " + JSON.stringify({ legacy, adaptive, steadyLegacy, steadyAdaptive }));

for(const result of [legacy, adaptive, steadyLegacy, steadyAdaptive])
{
